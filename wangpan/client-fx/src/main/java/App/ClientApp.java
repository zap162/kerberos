...
public class ClientApp {
    ...
    public static String AS_IP = "127.0.0.1";

    public static int TGS_Port = 18011;
    public static String TGS_IP = "127.0.0.1";

    public static int up_Load_Server_Port = 18012;
    public static String up_Load_Server_IP = "127.0.0.1";

    public static int down_Load_Server_Port = 18013;
    public static String down_Load_Server_IP = "127.0.0.1";
